...
public class ItemController {
    ...
    public ResponseEntity<List<ItemListResponseDto>> getSearchTitleItems(@RequestParam String title) {
        return ResponseEntity.ok(itemService.getSearchTitleItems(title));
    }
